...
function breachMainframe(e) {
    ...
    setTimeout(() => {
        ...
        customBox.style.cssText = "position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); background:#000; border:2px solid #ff003c; color:#00ff00; padding:20px; z-index:9999; font-family:'VT323', monospace; font-size:1.5rem; max-width: 400px; text-align:center;";
        customBox.innerHTML = "<p>COMMUNICATION SECURED.</p><button onclick='this.parentElement.remove()' style='background:#ff003c; color:#000; border:none; padding:5px 10px; font-family:Anton, sans-serif; cursor:pointer; margin-top:10px;'>CLOSE</button>";
