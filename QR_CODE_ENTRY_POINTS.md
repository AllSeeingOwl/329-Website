...
| Page / Route                                                   | Access Requirements                  | Recommended QR Type     | Recommended Phase | Narrative Context & Prop Suggestions                                                                                                                                                        |
| :------------------------------------------------------------- | :----------------------------------- | :---------------------- | :---------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **System Override**<br>`/system-override.html`                 | Public (In-universe Glitch Terminal) | **Dynamic / Static QR** | **Phase 3**       | **Infiltration Terminal**: Glitched tourist board page. Hide QR codes inside innocent-looking city tourism postcards or municipal transit flyers. _(Uses `public/system_override_qr.png`)_. |
