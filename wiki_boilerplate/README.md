# **THIS IS A BOILERPLATE / BARE-BONES VERSION OF THE REPOSITORY TO BE USED AS A FOUNDATION FOR FUTURE PROJECTS.**
...
- A bare-bones static `public/` directory with `index.html`, `404.html`, and `maintenance.html`.
